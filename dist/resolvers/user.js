...
let UserResolver = class UserResolver {
    ...
    register(options, { em }) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (err.code === '23505' || ((_a = err === null || err === void 0 ? void 0 : err.detail) === null || _a === void 0 ? void 0 : _a.includes("already exists"))) {
                    return {
                        errors: [{
                                field: "email",
    ...
    login(options, { em, req }) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield em.findOne(user_1.User, { email: options.email });
            if (!user) {
                return {
                    errors: [{
                            field: "email",
